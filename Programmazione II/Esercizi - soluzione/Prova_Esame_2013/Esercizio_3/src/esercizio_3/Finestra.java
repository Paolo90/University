...
public class Finestra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Etichetta.setText("Premi il pulsante per visualizzare l'effetto");
    ...
    private void PulsanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PulsanteActionPerformed
        ...
        try{
            double letto=Double.parseDouble(s);
            if(letto>=0)
                Etichetta.setText("POSITIVO");
            else
                Etichetta.setText("NEGATIVO");
